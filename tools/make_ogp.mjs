...
//
// 1200x630 でゲームを開き、HUD を隠して福山城天守 (PLATEAU LOD2) を見下ろす画をつくり、
...
/** photo=緯度,経度,注視高さ,距離,方位角 — 福山城天守を南南東から (背後を新幹線が走る) */
const QUERY = process.env.QUERY ?? 'debug=1&wp=1&nofps=1&q=high&photo=34.49104,133.36113,16,120,170';
const OUT = process.env.OUT ?? 'public';
mkdirSync(OUT, { recursive: true });

const CARDS = [
  { file: 'ogp.png', title: 'FUKUYAMA KART', sub: '福山グランプリ', lead: 'PLATEAU の3D都市モデルで走る、福山駅から鞆の浦まで 20.5km', foot: 'ブラウザで、いますぐ　/　インストール不要　/　最大8人のオンライン対戦' },
  { file: 'ogp-en.png', title: 'FUKUYAMA KART', sub: 'Fukuyama Grand Prix', lead: 'Fukuyama Station to Tomonoura, 20.5 km, from MLIT’s Project PLATEAU', foot: 'Play in your browser  /  no install  /  online multiplayer for up to 8' },
];
