...
// アトラス設定
// 福山は LOD2 が駅周辺の 6 メッシュに 4 千棟ほど。1 タイルを 128px (実画像 112px) にする
...
// LOD2 (実写テクスチャ) を含む福山市のメッシュ (福山駅・福山城の周り)
const MESHES = ['51335278', '51335279', '51335288', '51335289', '51335298', '51335299'];
...
// 軌道敷 (JR山陽本線・山陽新幹線) も建物を通せないので除外対象にする
...
function parseAppearance(text) {
  const map = new Map();
  // 広島のデータは Appearance がファイルの先頭、松江・福山は末尾にある
