...
/** 英語版の置き場所。配信の根からの相対 (GitHub Pages では /fukuyama-kart/en/) */
...
const JA: Dict = {
  ...
  'load.course': 'コース生成中...',
  'load.ground': '地形生成中...',
  'load.rail': '山陽新幹線・JR 山陽本線を敷設中...',
  'load.bldg': '建物 {0} 棟を生成中...',
  'load.bldgDone': '建物 {0} 棟を配置 (コース上 {1} 棟を除去)',
  'load.landmarks': '鞆の浦の常夜燈・弁天島・芦田川大橋を配置中...',
...
const EN: Dict = {
  ...
  'load.rail': 'Laying the Sanyo Shinkansen and JR Sanyo Line...',
  'load.bldg': 'Building {0} structures...',
  'load.bldgDone': 'Placed {0} buildings ({1} removed from the course)',
  'load.landmarks': 'Placing the Tomonoura Joyato, Bentenjima and Ashidagawa Ohashi...',
...
export function applyDomLang(): void {
  ...
  if (!onEnPath()) document.title = 'Fukuyama Kart — a browser kart racer on real PLATEAU 3D city data';
