...
**福山駅（スタート）→ 入船町 → 国道313号で JR を越える → 北吉津町 → 福山城 → 国道2号を西へ → 草戸稲荷神社 → 芦田川の西岸を南下 → 草戸大橋 → 水呑大橋 → 箕島町 → 芦田川大橋 → 水呑町 → 田尻町 → 鞆の浦 → 鞆港 常夜燈（ゴール）**

**20.5 km のワンウェイ。周回しません。** スタートとゴールが別の場所にあるので、`Track` は閉ループではなく開いた経路として扱います（後述）。

| 必ず通る地点 | どう通るか |
| --- | --- |
| 福山駅 | 駅前がスタート。まず東へ走り、国道313号で JR 山陽本線・山陽新幹線を越える |
| 福山城 | 線路の北側を西へ戻り、北吉津町から城山の東へ回り込む。天守は **PLATEAU の LOD2（実写テクスチャ）** がそのまま建っている |
| 草戸稲荷神社 | 駅の西で国道2号に入り、芦田川を渡ってすぐ南へ。国宝の明王院五重塔が並ぶ |
| 芦田川 | 西岸を南下し、草戸大橋（県道22号）で東岸へ渡って河口へ向かう |
| 芦田川大橋 | 県道380号で箕島町から水呑町へ。福山市で最初の斜張橋なので、主塔とケーブルは独自モデルで足している |
| 鞆港 常夜燈 | 県道22号を南へ 7km、鞆の町なかへ入って港の西側がゴール。**常夜燈**（1859年・高さ 11m）の手前で終わり、沖には **弁天島** が見える |

走っている道は 0〜1.6km が駅前の市道、1.6〜3.3km が国道313号と線路北側の市道、3.5〜4.5km が福山城まわり、4.5〜6km が国道2号、6〜9km が芦田川西岸の堤防道路、9〜12km が東岸の市道、12〜13km が県道380号、13〜20.5km が県道22号です。

全 AI で走らせると **約 5 分 40 秒**（`node tools/airace.mjs`）。広い国道では 220km/h 前後、幅 9m の市道や鞆の町なかでは AI も速度を落とします。
...
```
福山駅 → Fukuyama Sta. / 芦田川大橋 → Ashidagawa Ohashi Bridge / 鞆港 常夜燈 → Tomo Port Joyato
```
